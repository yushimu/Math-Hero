...
import { Play, Star, Flame, Trophy, Lock, Rocket } from 'lucide-react';
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { id: 'LEVEL_3', title: 'SD Awal', desc: 'Hitung (50)', icon: '🚀', color: 'bg-purple-100 text-purple-600 border-purple-200' },
            { id: 'LEVEL_4', title: 'SD', desc: 'Campuran', icon: '🔥', color: 'bg-orange-100 text-orange-600 border-orange-200' },
          ].map((level, idx) => (
            <motion.div
              key={level.id}
              initial={{ opacity: 0, y: 20 }}
